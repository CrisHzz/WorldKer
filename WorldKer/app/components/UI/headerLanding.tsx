            ...
            <div className="flex flex-col sm:flex-row items-center justify-center w-full mt-2 sm:mt-0">
              <div className="flex-grow flex justify-center">
                <div className="flex space-x-4">
                  <a href="#nosotros" className="relative text-white hover:text-blue-300 font-figtree font-bold group">
                    Sobre Nosotros
                  ...
                  <a href="#pilares" className="relative text-white hover:text-blue-300 font-figtree font-bold group">
                    Nuestros Pilares
                    <span className="absolute left-0 bottom-0 w-full h-[2px] bg-blue-300 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                  </a>
                  <a href="#precios" className="relative text-white hover:text-blue-300 font-figtree font-bold group">
                    Precios
                    <span className="absolute left-0 bottom-0 w-full h-[2px] bg-blue-300 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                  </a>
                  <a href="#contacto" className="relative text-white hover:text-blue-300 font-figtree font-bold group">
                    Contacto
                    <span className="absolute left-0 bottom-0 w-full h-[2px] bg-blue-300 scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                  </a>
                </div>
